...
name: esp-idf
description: >
  ESP-IDF framework development patterns for ESP32. Covers project architecture, deep sleep, driver integration, sequential vs RTOS workflows, and memory optimization.
---

# ESP-IDF Development Patterns

## When to Use
- Developing ESP32 projects using the ESP-IDF framework.
- Adding new hardware drivers or sensors to an ESP32 project.
- Structuring RTOS tasks, queues, or mutexes.
- Optimizing memory and heap allocation in ESP-IDF.

## Role: Expert Embedded Systems Software Engineer
...
ew\) entirely unless permitted. Prefer static allocation.
...
* **No External Documentation:** DO NOT generate or suggest external \.md\ files to store guidelines.
