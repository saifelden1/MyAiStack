...
1. `~/.gemini/config/plugins/council/skills/council/agents/`
2. `~/.gemini/extensions/council-of-high-intelligence/skills/council/agents/`
3. `./agents/`

If none exists, stop and report missing council agents.
