...
name: esp-idf-n
description: >
  ESP-IDF-n framework development patterns for ESP32. Covers low-level drivers, low-power states, peripheral isolation, and RTOS best practices.
---

# ESP-IDF Development Patterns

## When to Use
- Developing firmware specifically focusing on ESP-IDF-n constraints.
- Managing ESP32 peripheral isolation and communication drivers.
- Implementing low-power or deep sleep designs on ESP32.
